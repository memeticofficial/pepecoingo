...
// Package state manages the meta-data required by consensus for an pepecoin
// dag.
package state
...
func (s *Serializer) ParseVtx(ctx context.Context, b []byte) (pepecoin.Vertex, error) {
...
func (s *Serializer) GetVtx(_ context.Context, vtxID ids.ID) (pepecoin.Vertex, error) {
