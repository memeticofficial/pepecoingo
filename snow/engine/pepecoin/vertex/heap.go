...
type priorityQueue []pepecoin.Vertex
...
func (vh *maxHeightVertexHeap) Push(vtx pepecoin.Vertex) bool {
	vtxID := vtx.ID()
...
func (vh *maxHeightVertexHeap) Pop() pepecoin.Vertex {
	vtx := heap.Pop(&vh.heap).(pepecoin.Vertex)
